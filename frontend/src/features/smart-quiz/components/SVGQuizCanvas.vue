<template>
  <div class="relative w-full h-full">
    ...
    <div
      ...
      class="absolute top-3 left-3 px-3 py-1 rounded-lg bg-red-500/10 border border-red-500/20"
    >
      <span class="text-red-400 text-[10px] font-bold">🔒 VCR LOCKED</span>
    </div>

    <!-- Step Indicator -->
    <div class="absolute bottom-3 left-3 px-3 py-1 rounded-lg bg-slate-800/80 border border-slate-700">
