<template>
  ...
  >
    <div class="flex items-center justify-between mb-1.5">
      <span class="text-[10px] font-mono text-amber-400/80 bg-amber-500/10 px-1.5 py-0.5 rounded">
        {{ heapObject.address }}
      </span>
    ...
    <div class="space-y-0.5">
      <div
        ...
        :key="fieldName"
        class="flex items-center justify-between text-[11px] font-mono px-1 py-0.5 rounded bg-slate-800/30"
      >
        <span class="text-slate-500">{{ fieldName }}</span>
