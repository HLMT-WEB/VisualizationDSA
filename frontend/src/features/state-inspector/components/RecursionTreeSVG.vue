  ...
  <div class="recursion-tree-container">
    <div class="px-3 py-2 border-b border-slate-700/50">
      <div class="flex items-center justify-between">
        <h3 class="text-xs font-semibold text-emerald-400 uppercase tracking-wider">
          Cây Đệ Quy
        </h3>
        <div class="flex items-center gap-2">
          ...
          <span
            ...
            class="text-[10px] px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"
          >
            Depth {{ maxDepth }}
          </span>
        </div>
    ...
    <div class="p-3 overflow-auto">
      ...
      <div v-else class="text-center text-slate-600 text-sm italic py-6">
